...
function displayResults(data) {
  ...
  // Set weather icon and description (outside the loop as they are not forecast specific)
  const iconsrc = `https://openweathermap.org/img/w/${forecasts[0].weather[0].icon}.png`;
  weatherIcon.setAttribute('src', iconsrc);
  weatherIcon.setAttribute('alt', forecasts[0].weather[0].description);
  captionDesc.textContent = forecasts[0].weather[0].description;
}
*/
